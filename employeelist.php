...
//分页
$num_in_page = 20;
$sql_num = "select count(*) from ".$db_employee." where `checked`=1";
...
$employee_len = 40;
$sql_employee = "select * from ".$db_employee." where `checked`=1 order by `mod_time` desc limit ".$limitS.",".$num_in_page;
