          ...
          <td align="middle"><div id="pnlFirst">
            <table cellspacing="0" width="100%" border="1" bordercolor="#FFFFFF">
              <form action="register.php"  method="post"  name="form" id="form">
                ...
                <tr align="left" bgcolor="#fffae8">
                  <td height="25" colspan="2">【基本信息】
                    ...
                    <tr>
                      <td height="19">
                                <div align="left">
                                  ...
                                  *
                                  <input type="button" name="Submit" value="检查用户名是否存在" onclick="return checkusername()">
                              </div>                              
                ...
                <tr bgcolor="#fffae8">
                  ...
                  <td><div align="left"><font face="宋体">
                    <input id="txtPassword" type="password" name="password1" maxlength="16"/>
...
</font><font face="宋体">* 请牢记填写的答案</font></div></td>
                </tr>
                <tr bgcolor="#fffae8">
                  <td align="right" height="25" colspan="2"><p align="left">【详细信息】</p></td>
                </tr>
                <tr bgcolor="#fffae8">
...
?>
                ...
                <tr bgcolor="#fffae8">
                  <td height="25" colspan="2" align="left">【雇员具体要求】</td>
                  </tr>
                <tr bgcolor="#fffae8">
...
*（最好填面议）</td>
                ...
                <tr bgcolor="#fffae8">
                  <td align="right" height="25">文凭要求：</td>
                  <td align="left"><select name="ideal_degree">
					  <?php
...
?>
                ...
                <tr bgcolor="#fffae8">
                  <td align="right" height="25">性别要求：</td>
                  <td align="left"><font face="宋体">
                    <select  name="ideal_sex">
...
*                  </font></td>
                ...
                <tr bgcolor="#fffae8">
                  <td align="right" height="25">年龄要求：</td>
                  <td align="left"><select name="ideal_age" style="FONT-SIZE: 12px; BACKGROUND-COLOR: #ffffff" size="1">
                    <option value="年龄不限" selected="selected">年龄不限</option>
                ...
                <tr bgcolor="#fffae8">
                  <td align="right" height="25">是否住家：</td>
                  <td align="left"><select name="home">
                ...
                <tr bgcolor="#fffae8">
                  <td align="right" height="25">工作期限：</td>
                  <td align="left"><input type="text" name="worktime" /> 
                    * 如长期、短期等</td>
                </tr>
                <tr bgcolor="#fffae8">
                  <td align="right" height="64">具体要求和说明：</td>
                  <td align="left"><textarea name="requirement" cols="40" rows="5"></textarea></td>
                </tr>
                <tr>
                  <td align="middle" bgcolor="#fff2cd" colspan="2" height="30"><div align="center">
                    <input id="submit"  type="submit" value=" 提交 " name="submit" onclick="return checkemployer();" />
                    &nbsp;
